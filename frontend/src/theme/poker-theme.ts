    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          '&:hover': {
            background: `linear-gradient(135deg, ${pokerColors.accent.light} 0%, ${pokerColors.accent.dark} 100%)`,
            boxShadow: '0 8px 25px 0 rgba(245, 158, 11, 0.35)',
          },
        },
        outlined: {
          ...
          '&:hover': {
            borderColor: pokerColors.accent.dark,
